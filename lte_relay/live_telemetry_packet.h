...
// Shared packet mirror used by the standalone relay sketch. Keep this
// definition byte-for-byte compatible with telem-v2/telemetry_v2.
...
static_assert(sizeof(LiveTelemetryPacket) == 54, "Live telemetry packet layout changed");
